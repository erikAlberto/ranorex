...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    ...
    public partial class InsertAge : ITestModule
    {
        ...
        public InsertAge()
        {
            txtAge = "{LControlKey down}{Akey}{LControlKey up}{Delete}";
        }
...
#region Variables
        ...
        /// <summary>
        /// Gets or sets the value of variable txtAge.
        /// </summary>
        [TestVariable("93dd0421-dc43-42c5-884a-108af5bcf361")]
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence '{Back}' with focus on 'DemoApplication'.", repo.DemoApplication.SelfInfo, new RecordItemIndex(1));
            repo.DemoApplication.Self.EnsureVisible();
            Keyboard.Press("{Back}");
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence from variable '$txtAge' with focus on 'DemoApplication.DatabaseTab.Age'.", repo.DemoApplication.DatabaseTab.AgeInfo, new RecordItemIndex(2));
            repo.DemoApplication.DatabaseTab.Age.PressKeys(txtAge);
            Delay.Milliseconds(0);
